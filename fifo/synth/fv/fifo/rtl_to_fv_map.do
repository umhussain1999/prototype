...
# Generated on: Wed Feb 25 14:03:53 CST 2026 (Wed Feb 25 20:03:53 UTC 2026)
...
set logfile fv/fifo/rtl_to_fv_map.log ;# user can modify this name for succeeding runs
...
read_implementation_information fv/fifo -revised fv_map -use_rtl_names
...
read_design  -define SYNTHESIS  -merge bbox -golden -lastmod -noelab  -verilog2k ../fifo.v
elaborate_design -golden -root {fifo} -rootonly -rootonly  

read_design -verilog95   -revised -lastmod -noelab fv/fifo/fv_map.v.gz
elaborate_design -revised -root {fifo}
...
set_analyze_option -mapping_file fv/fifo/fv_map.map.do
...
set_system_mode lec
write_compared_points noneq.compared_points.fifo.rtl.fv_map.tcl -class noneq -tclmode -replace
set lec_version_required "21.10100"
if {$lec_version >= $lec_version_required} {
    analyze_nonequivalent -source_diagnosis
    report_nonequivalent_analysis > noneq.source_diag.fifo.rtl.fv_map.rpt
}
report_test_vector -noneq > noneq.test_vector.fifo.rtl.fv_map.rpt
