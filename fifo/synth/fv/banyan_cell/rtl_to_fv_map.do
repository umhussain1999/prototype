...
# Generated on: Fri Feb 13 16:14:04 CST 2026 (Fri Feb 13 22:14:04 UTC 2026)
...
set logfile fv/banyan_cell/rtl_to_fv_map.log ;# user can modify this name for succeeding runs
...
read_implementation_information fv/banyan_cell -revised fv_map -use_rtl_names
...
set env(CDN_SYNTH_ROOT) "/tools/cadence_data/installs/DDI251/GENUS251/tools.lnx86"
set CDN_SYNTH_ROOT      "/tools/cadence_data/installs/DDI251/GENUS251/tools.lnx86"
set env(CW_DIR) "/tools/cadence_data/installs/DDI251/GENUS251/tools.lnx86/lib/chipware"
set CW_DIR      "/tools/cadence_data/installs/DDI251/GENUS251/tools.lnx86/lib/chipware"
set lec_version_required "21.20249"
if { ($lec_version < $lec_version_required) &&
    [file exists /tools/cadence_data/installs/DDI251/GENUS251/tools.lnx86/lib/chipware/old_encrypt_sim]} {
    set env(CW_DIR_SIM) "/tools/cadence_data/installs/DDI251/GENUS251/tools.lnx86/lib/chipware/old_encrypt_sim"
    set CW_DIR_SIM      "/tools/cadence_data/installs/DDI251/GENUS251/tools.lnx86/lib/chipware/old_encrypt_sim"
} else {
    set env(CW_DIR_SIM) "/tools/cadence_data/installs/DDI251/GENUS251/tools.lnx86/lib/chipware/sim"
    set CW_DIR_SIM      "/tools/cadence_data/installs/DDI251/GENUS251/tools.lnx86/lib/chipware/sim"
}
...
add_search_path . /tools/cadence_data/installs/DDI251/GENUS251/tools.lnx86/lib/tech -library -both
read_library -liberty -both \
    /tools/cadence_data/PDKs_and_License_File/std_cell_28/TS55LB000-FE-r0p0-00eac0/arm/tsmc/cln28lp/sc12mc_base_svt_c40/r0p0/lib/sc12mc_cln28lp_base_svt_c40_tt_typical_max_1p05v_25c.lib
...
read_design  -define SYNTHESIS  -merge bbox -golden -lastmod -noelab  -verilog2k ../banyan.v
elaborate_design -golden -root {banyan_cell} -rootonly 

read_design -verilog95   -revised -lastmod -noelab fv/banyan_cell/fv_map.v.gz
elaborate_design -revised -root {banyan_cell}
...
set_analyze_option -mapping_file fv/banyan_cell/fv_map.map.do
...
set_system_mode lec
write_compared_points noneq.compared_points.banyan_cell.rtl.fv_map.tcl -class noneq -tclmode -replace
set lec_version_required "21.10100"
if {$lec_version >= $lec_version_required} {
    analyze_nonequivalent -source_diagnosis
    report_nonequivalent_analysis > noneq.source_diag.banyan_cell.rtl.fv_map.rpt
}
report_test_vector -noneq > noneq.test_vector.banyan_cell.rtl.fv_map.rpt
