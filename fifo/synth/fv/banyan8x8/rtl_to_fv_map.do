...
# Generated on: Fri Feb 13 16:15:25 CST 2026 (Fri Feb 13 22:15:25 UTC 2026)
...
set logfile fv/banyan8x8/rtl_to_fv_map.log ;# user can modify this name for succeeding runs
...
read_implementation_information fv/banyan8x8 -revised fv_map -use_rtl_names
...
elaborate_design -golden -root {banyan8x8} -rootonly 

read_design -verilog95   -revised -lastmod -noelab fv/banyan8x8/fv_map.v.gz
elaborate_design -revised -root {banyan8x8}
...
set_analyze_option -mapping_file fv/banyan8x8/fv_map.map.do
...
set_system_mode lec
write_compared_points noneq.compared_points.banyan8x8.rtl.fv_map.tcl -class noneq -tclmode -replace
set lec_version_required "21.10100"
if {$lec_version >= $lec_version_required} {
    analyze_nonequivalent -source_diagnosis
    report_nonequivalent_analysis > noneq.source_diag.banyan8x8.rtl.fv_map.rpt
}
report_test_vector -noneq > noneq.test_vector.banyan8x8.rtl.fv_map.rpt
